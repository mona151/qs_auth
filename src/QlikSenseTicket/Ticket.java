...
public class Ticket
{
    public static String HTTPSCall()
    {
        String xrfkey = "7rBHABt65vFflaZ7"; //Xrfkey to prevent cross-site issues
        String host = "qliksensei"; //Enter the Qlik Sense Server hostname here
        String vproxy = "midas"; //Enter the prefix for the virtual proxy configured in Qlik Sense Steps Step 1
        try
        {
            String user = "testnovartis";
            String userDir = "qliksensei";
            ...
            String proxyCertPass="midastest"; //This is the password to access the Java Key Store information
            ...
            String rootCertPass = "midastest"; //This is the password to access the Java Key Store information
            ...
            System.out.println(jo.get("Ticket"));
            return (String) jo.get("Ticket");
